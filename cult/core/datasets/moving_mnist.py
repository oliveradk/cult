...
__all__ = ['CommonMNIST', 'CommonFashionMNIST', 'MovingMNIST', 'MovingFashionMNIST', 'FixedMNIST', 'OrderedMNIST',
           'OrderedFashionMNIST']
...
# Cell
class OrderedMNIST(CommonMNIST):

    def __init__(self, *args, **kwargs):
        super().__init__(*args, **kwargs)

        sorted_targets, sorted_indices = torch.sort(self.targets)
        self.targets = sorted_targets
        self.data = self.data[sorted_indices]


# Cell
class OrderedFashionMNIST(CommonFashionMNIST):
